...
import InteractiveLogin from './components/HandlingReportComponent';
      ...
      <div className='d-flex flex-grow-1'>
        ...
        <main id='main-container' className='container-fluid p-4' data-testid='main-container'>
          <header className='mb-4 border-bottom pb-3'>
            <h1 id='main-title' className='display-6 text-dark' data-testid='main-title'>
              DOM Testing Environment OH YEAH xd
            </h1>
            <p className='text-muted fs-5'>
              Testing the new interactive login component
            </p>
          </header>
